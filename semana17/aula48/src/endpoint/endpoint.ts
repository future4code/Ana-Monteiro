...
import {selectAllUsers, selectAllNames, selectAllTypes, selectOrder} from "../query/query"
...
export const getAllOrder = async(req: Request,res: Response, type: string, order: string): Promise<void> =>{
   try {
      const users = await selectOrder(type, order)
